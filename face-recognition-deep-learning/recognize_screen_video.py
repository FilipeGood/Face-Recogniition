...
import pyautogui
"""
python3 recognize_screen_video.py --detector face_detection_model \
...
detector = cv2.dnn.readNetFromCaffe(protoPath, modelPath) # face detector

embedder = cv2.dnn.readNetFromTorch(args["embedding_model"])  # feature extractor
